            ...
            <div class="row g-0">
                ...
                <div class="col-lg-5 col-md-12 about-content-wrapper">
                    <div class="about-content">
                        <h2>Transforming Immune Pathways Into Multi-Disease Solutions</h2>
                ...
                <div class="col-lg-7 col-md-12 about-image-container">
                    <div class="about-image">
                        <img src="./images/sections/home-section-3-new.jpg" alt="Elemental Biologics Laboratory" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
