<link rel="stylesheet" type="text/css" href="./css/about-section-2-style.css">
<div class="content-sections">
    <!-- Mission Section -->
    <section class="content-card">
        <div class="icon-container">
            <img src="./images/icons/icon (1).svg" alt="Mission icon" class="content-icon">
        </div>
    ...
    <section class="content-card">
        <div class="icon-container">
            <img src="./images/icons/icon (2).svg" alt="Vision icon" class="content-icon">
        </div>
        <div class="text-content">
    ...
    <section class="content-card">
        <div class="icon-container">
            <img src="./images/icons/icon (3).svg" alt="Values icon" class="content-icon">
        </div>
        <div class="text-content">
